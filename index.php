...
<body>
    <ol>
        ...
        <li><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#recentEvents">Recent Events</button></li>
        <li><a href="action.php?activeEvent=1">Active Events</a></li>
        <li><a href="action.php?requiredStaff=1">Required Staff</a></li>
        <li><a href="action.php?returningCustomer=1">Returning Customers</a></li>
        <li><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#recentIncome">Recent Income</button></li>
        <li></li>
